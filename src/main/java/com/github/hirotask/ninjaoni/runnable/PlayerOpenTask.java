...
public class PlayerOpenTask extends BukkitRunnable {
    ...
    private int count = 0;
    private com.github.hirotask.ninjaoni.Ninja ninja; //シフトを押している忍者
    private com.github.hirotask.ninjaoni.Ninja locked; //解除対象

    public PlayerOpenTask(com.github.hirotask.ninjaoni.Ninja ninja, com.github.hirotask.ninjaoni.Ninja locked, int count) {
        ...
        if (ninja.getTeam() == com.github.hirotask.ninjaoni.Game.Teams.PLAYER) {
            ...
            if (locked != null) {
                if (count == 0) {
                    ...
                    com.github.hirotask.ninjaoni.utils.MessageManager.sendAll(ChatColor.RED + locked.getPlayer().getName() + ChatColor.WHITE + "が開放された！");
