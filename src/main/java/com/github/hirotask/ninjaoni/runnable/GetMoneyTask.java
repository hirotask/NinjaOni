...
public class GetMoneyTask extends BukkitRunnable {
    ...
    private int count = 0;
    private com.github.hirotask.ninjaoni.Ninja ninja;
    private ArmorStand stand;

    public GetMoneyTask(com.github.hirotask.ninjaoni.Ninja ninja, ArmorStand stand, int count) {
        this.ninja = ninja;
        this.count = count * 20;
        this.stand = stand;
    }
    ...
    public void run() {
        ...
        if (count == 0) {
            ...
            if (inv.getItem(18) == null || inv.getItem(18).clone().getAmount() <= 0) {
                inv.setItem(18, com.github.hirotask.ninjaoni.inventory.ItemManager.getMoney());
            } else {
                int amount = inv.getItem(18).clone().getAmount();
                ItemStack item = com.github.hirotask.ninjaoni.inventory.ItemManager.getMoney().clone();
