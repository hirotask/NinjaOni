        ...
        if (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK) {
            if (com.github.hirotask.ninjaoni.NinjaManager.getInstance().containsNinja(player)) {
                ...
                for (com.github.hirotask.ninjaoni.inventory.item.NinjaItem ninjaItem : itemManager.getNinjaItems()) {
                    ...
                    } else if (ninjaItem.ninjaItemType() == com.github.hirotask.ninjaoni.inventory.item.NinjaItem.NinjaItemType.PLAYER_ITEM && ninja.getTeam() == com.github.hirotask.ninjaoni.Game.Teams.PLAYER) {
                        if (item.getType() == ninjaItem.type()) {
                            ninjaInventory.decrementHolderItem(itemManager.getItem(ninjaItem));
