...
public class NinjaItemListener implements Listener {
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        com.github.hirotask.mc1171.inventory.NinjaInventory ninjaInventory = new com.github.hirotask.mc1171.inventory.NinjaInventory(inv);
        com.github.hirotask.mc1171.inventory.ItemManager itemManager = com.github.hirotask.mc1171.NinjaOniAPI.getInstance().getItemManager();
        ...
        if (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK) {
            if (com.github.hirotask.mc1171.NinjaManager.getInstance().containsNinja(player)) {
                ...
                for (com.github.hirotask.mc1171.inventory.item.NinjaItem ninjaItem : itemManager.getNinjaItems()) {
                    if (ninjaItem.ninjaItemType() == com.github.hirotask.mc1171.inventory.item.NinjaItem.NinjaItemType.ONI_ITEM && ninja.getTeam() == com.github.hirotask.mc1171.Game.Teams.ONI) {
                        if (item.getType() == ninjaItem.type()) {
                            ninjaInventory.decrementHolderItem(itemManager.getItem(ninjaItem));

                            ninjaItem.execute(ninja);
                        }
                    } else if (ninjaItem.ninjaItemType() == com.github.hirotask.mc1171.inventory.item.NinjaItem.NinjaItemType.PLAYER_ITEM && ninja.getTeam() == com.github.hirotask.mc1171.Game.Teams.PLAYER) {
                        if (item.getType() == ninjaItem.type()) {
                            ninjaInventory.decrementHolderItem(itemManager.getItem(ninjaItem));
    ...
    public void onClickInv(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getType() == com.github.hirotask.mc1171.inventory.ItemManager.getMoney().getType() && e.getSlot() == 18) {
            e.setCancelled(true);
            return;
        }
