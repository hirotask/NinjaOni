...
public enum NinjaOniAPI {
    ...
    @Getter
    private NinjaManager ninjaManager = com.github.hirotask.mc1171.NinjaManager.getInstance();


    public static void setInstance(com.github.hirotask.mc1171.NinjaOni2 plugin) {
        INSTANCE.plugin = plugin;
    }

    public static com.github.hirotask.mc1171.NinjaOniAPI getInstance() {
        if(INSTANCE.plugin == null) {
            return null;
        }

        if(INSTANCE.game == null) {
            INSTANCE.game = new com.github.hirotask.mc1171.Game();
        }
        ...
        if(INSTANCE.itemManager == null) {
            INSTANCE.itemManager = new com.github.hirotask.mc1171.inventory.ItemManager();
        }
