...
public final class NinjaOni2 extends JavaPlugin {
    ...
    public void onEnable() {
        com.github.hirotask.mc1171.NinjaOniAPI.setInstance(this);
        com.github.hirotask.mc1171.NinjaOniAPI.getInstance().getGame().setup();

        //コマンドの設定
        CommandAPI.registerCommand(com.github.hirotask.mc1171.NinjaCommand.class);
